...
export const ProductArea: FC<Props> = ({ product, width }) => {
	...
	return (
		<>
			...
			<div className='mx-auto px-4 xs:px-12 pb-36 lg:pb-24 max-w-screen-xl flex flex-col gap-8'>
				<h1 className='text-4xl lg:text-5xl text-justify'>Descrição</h1>
				<p className='text-justify'>{product!.description}</p>
				<button className='rounded text-light mx-auto w-[150px] border border-light bg-yellow-500 px-4 py-2 flex justify-center items-center gap-2'>
					<p>Favoritar</p>
					<svg
						xmlns='http://www.w3.org/2000/svg'
						viewBox='0 0 24 24'
